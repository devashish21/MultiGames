...
import static com.example.devashish.multigames.R.id.button5;
import static com.example.devashish.multigames.R.id.end;
import static com.example.devashish.multigames.R.id.view;
...
public class HomeFragment extends Fragment {
    Button b1, b2, b3, b4, b5, b6, b7, b8, b9,button5;
  ...
  //  @Override
    LinearLayout linearLayout;
        public View onCreateView(LayoutInflater inflater,
            ...
            linearLayout = (LinearLayout) v.findViewById(R.id.my_home);
...

    {
        ...
        {
            Toast.makeText(HomeFragment.this.getActivity(), "Winner Player X!", Toast.LENGTH_LONG).show();
            end = true;
        }
        ...
        {
            Toast.makeText(HomeFragment.this.getActivity(), "Winner Player O!", Toast.LENGTH_LONG).show();
            end = true;
        }
